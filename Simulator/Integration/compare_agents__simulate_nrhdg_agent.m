classdef compare_agents__simulate_nrhdg_agent < matlab.System
% Python def simulate_nrhdg_agent imported from python module compare_agents.py
...
function [y] = stepImpl(obj,agent,initial_state,target_state,steps)
    y = double(py.compare_agents.simulate_nrhdg_agent(agent,initial_state,target_state,steps));
end
