...
#include "m_ufHc4f81uWnfvSns6Th8ZE.h"
...
static void cgxe_mdl_start(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance);
static void CheckPythonError(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *dict, char_T *key);
static void c_assignToPyDict(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *c_getPyDictVal(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *d_getPyDictVal(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance, PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_ufHc4f81uWnfvSns6Th8ZE
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  b_execPyScript(moduleInstance,
                 "import integration as functions\noutput = functions.testing()\nx = output[0]\ny = output[1]",
...
/* CGXE Glue Code */
static void mdlOutputs_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S, int_T tid)
{
  InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance =
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S)
{
  InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance =
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S, int_T tid)
{
  InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance =
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S)
{
  InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance =
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S)
{
  InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance =
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S)
{
  InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance =
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S)
{
  InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance =
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S)
{
  InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *moduleInstance =
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE *)calloc(1, sizeof
    (InstanceStruct_ufHc4f81uWnfvSns6Th8ZE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_ufHc4f81uWnfvSns6Th8ZE);
  ssSetmdlInitializeConditions(S, mdlInitialize_ufHc4f81uWnfvSns6Th8ZE);
  ssSetmdlUpdate(S, mdlUpdate_ufHc4f81uWnfvSns6Th8ZE);
  ssSetmdlDerivatives(S, mdlDerivatives_ufHc4f81uWnfvSns6Th8ZE);
  ssSetmdlTerminate(S, mdlTerminate_ufHc4f81uWnfvSns6Th8ZE);
  ssSetmdlEnable(S, mdlEnable_ufHc4f81uWnfvSns6Th8ZE);
  ssSetmdlDisable(S, mdlDisable_ufHc4f81uWnfvSns6Th8ZE);
...
static void mdlProcessParameters_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S)
{
}

void method_dispatcher_ufHc4f81uWnfvSns6Th8ZE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_ufHc4f81uWnfvSns6Th8ZE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_ufHc4f81uWnfvSns6Th8ZE(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: ufHc4f81uWnfvSns6Th8ZE.\n"
...
mxArray *cgxe_ufHc4f81uWnfvSns6Th8ZE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_ufHc4f81uWnfvSns6Th8ZE_fallback_info(void)
{
