...
static void cgxe_mdl_start(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance);
static void CheckPythonError(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *dict, char_T *key);
static void c_assignToPyDict(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *c_getPyDictVal(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *d_getPyDictVal(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance, PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  b_execPyScript(moduleInstance,
                 "import Simulator.integration as functions\noutput = functions.testing()\nx = output[0]\ny = output[1]",
...
/* CGXE Glue Code */
static void mdlOutputs_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S, int_T tid)
{
  InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance =
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S)
{
  InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance =
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S, int_T tid)
{
  InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance =
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S)
{
  InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance =
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S)
{
  InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance =
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S)
{
  InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance =
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S)
{
  InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance =
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S)
{
  InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *moduleInstance =
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F *)calloc(1, sizeof
    (InstanceStruct_YQg0KPp9US1iRXoVC2Rf7F));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_YQg0KPp9US1iRXoVC2Rf7F);
  ssSetmdlInitializeConditions(S, mdlInitialize_YQg0KPp9US1iRXoVC2Rf7F);
  ssSetmdlUpdate(S, mdlUpdate_YQg0KPp9US1iRXoVC2Rf7F);
  ssSetmdlDerivatives(S, mdlDerivatives_YQg0KPp9US1iRXoVC2Rf7F);
  ssSetmdlTerminate(S, mdlTerminate_YQg0KPp9US1iRXoVC2Rf7F);
  ssSetmdlEnable(S, mdlEnable_YQg0KPp9US1iRXoVC2Rf7F);
  ssSetmdlDisable(S, mdlDisable_YQg0KPp9US1iRXoVC2Rf7F);
...
static void mdlProcessParameters_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S)
{
}

void method_dispatcher_YQg0KPp9US1iRXoVC2Rf7F(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_YQg0KPp9US1iRXoVC2Rf7F(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_YQg0KPp9US1iRXoVC2Rf7F(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: YQg0KPp9US1iRXoVC2Rf7F.\n"
...
mxArray *cgxe_YQg0KPp9US1iRXoVC2Rf7F_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_YQg0KPp9US1iRXoVC2Rf7F_fallback_info(void)
{
